...
- Bios update: As of 2017-05-23, the latest BIOS available is 1.4.17
  (available [[https://downloads.dell.com/FOLDER04325565M/1/XPS_9350_1.4.17.exe][here]]). Download and store on a USB flash drive, boot on
  it (=F12=), and follow instructions. To check current version of
  BIOS:
  : sudo dmidecode | less
