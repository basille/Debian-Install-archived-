...
#+BEGIN_SRC sh
    ...
    cd ~
    getfacl -R . > /mnt/<USER>/home/.file-acl
    ### Restore file ACLs (in the file-acl directory)
    # setfacl --restore=.file-acl
    
    ### Entire /home except: 
    ### photos, music, videos, caches/thumbnails, .extraswap, emacs.d/elpa/,
    ### .R-site/site-library/, Torbrowser, Trash and some folders in  Download
